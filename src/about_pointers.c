...
Test(about_pointers, pointers_and_addresses)
{
    ...
    */
    ...
    cr_assert_eq(
        sizeof(i), 0x4, "What is the size of an int on a 64 bit machine?");
    cr_assert_eq(sizeof(iptr), 0x8,
    ...
    */
    ...
    cr_assert_eq(sizeof(k), 0x4, "What type is k?");
    cr_assert_eq(sizeof(l), 0x8, "What type is l?");
    cr_assert_eq(sizeof(m), 0x8, "What type is m?");
    cr_assert_eq(sizeof(n), 0x4, "What type is n?");
}
...
Test(about_pointers, pointers_arrays_and_arithmetic)
{
    ...
    */
    cr_assert_eq((long)((long)p2 - (long)p1), 0x4,
